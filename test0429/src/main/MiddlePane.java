...
public class MiddlePane extends JPanel implements ActionListener{
	...
	// 배경 이미지
	private ImageIcon backGround = new ImageIcon(MiddlePane.class.getResource("/img/bckimg/middlepg.jpg")); // 배경 이미지 세팅

	public MiddlePane() {
		pick = new Pickax();
		dao = new ClickerDAO();
		ImageIcon scroll1, scroll2, scroll3, scroll4, scroll5, scroll6, scroll7;
		...
		add(paneCenGrid, BorderLayout.CENTER);
...
//				s.setVisible(true);
		...
		add(paneBot, BorderLayout.SOUTH);
